    ...
    With UserList(UserIndex)
        ...
        If UserClase = eClass.Cleric Or _
           ...
           UserClase = eClass.Mage Then
            ...
            .Stats.UserHechizos(hSlot) = 2 'Proyectil mágico
...
Sub CloseUser(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        'Si esta en algun evento lo llevamos a su hogar
        If .flags.ArenaRinkel Or .flags.EstaDueleando Or .flags.EstaPlantando Then _
            Call MandaraCasa(UserIndex)
