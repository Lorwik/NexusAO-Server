...
Sub LoadSini()
    ...
    BootDelBackUp = val(GetVar(ConfigPath & "Server.ini", "INIT", "IniciarDesdeBackUp"))
    
    'Misc
    
    Puerto = val(GetVar(ConfigPath & "Server.ini", "INIT", "StartPort"))
    HideMe = val(GetVar(ConfigPath & "Server.ini", "INIT", "Hide"))
    AllowMultiLogins = val(GetVar(ConfigPath & "Server.ini", "INIT", "AllowMultiLogins"))
    IdleLimit = val(GetVar(ConfigPath & "Server.ini", "INIT", "IdleLimit"))
    'Lee la version correcta del cliente
    ULTIMAVERSION = GetVar(ConfigPath & "Server.ini", "INIT", "Version")
    
    PuedeCrearPersonajes = val(GetVar(ConfigPath & "Server.ini", "INIT", "PuedeCrearPersonajes"))
    ServerSoloGMs = val(GetVar(ConfigPath & "Server.ini", "init", "ServerSoloGMs"))
    
    ArmaduraImperial1 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraImperial1"))
    ArmaduraImperial2 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraImperial2"))
    ArmaduraImperial3 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraImperial3"))
    TunicaMagoImperial = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaMagoImperial"))
    TunicaMagoImperialEnanos = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaMagoImperialEnanos"))
    ArmaduraCaos1 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraCaos1"))
    ArmaduraCaos2 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraCaos2"))
    ArmaduraCaos3 = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraCaos3"))
    TunicaMagoCaos = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaMagoCaos"))
    TunicaMagoCaosEnanos = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaMagoCaosEnanos"))
    
    VestimentaImperialHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "VestimentaImperialHumano"))
    VestimentaImperialEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "VestimentaImperialEnano"))
    TunicaConspicuaHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaConspicuaHumano"))
    TunicaConspicuaEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaConspicuaEnano"))
    ArmaduraNobilisimaHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraNobilisimaHumano"))
    ArmaduraNobilisimaEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraNobilisimaEnano"))
    ArmaduraGranSacerdote = val(GetVar(ConfigPath & "Server.ini", "INIT", "ArmaduraGranSacerdote"))
    
    VestimentaLegionHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "VestimentaLegionHumano"))
    VestimentaLegionEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "VestimentaLegionEnano"))
    TunicaLobregaHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaLobregaHumano"))
    TunicaLobregaEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaLobregaEnano"))
    TunicaEgregiaHumano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaEgregiaHumano"))
    TunicaEgregiaEnano = val(GetVar(ConfigPath & "Server.ini", "INIT", "TunicaEgregiaEnano"))
    SacerdoteDemoniaco = val(GetVar(ConfigPath & "Server.ini", "INIT", "SacerdoteDemoniaco"))
    
    MAPA_PRETORIANO = val(GetVar(ConfigPath & "Server.ini", "INIT", "MapaPretoriano"))
    
    EnTesting = val(GetVar(ConfigPath & "Server.ini", "INIT", "Testing"))
    
    'Intervalos
    SanaIntervaloSinDescansar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "SanaIntervaloSinDescansar"))
    FrmInterv.txtSanaIntervaloSinDescansar.Text = SanaIntervaloSinDescansar
    
    StaminaIntervaloSinDescansar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "StaminaIntervaloSinDescansar"))
    FrmInterv.txtStaminaIntervaloSinDescansar.Text = StaminaIntervaloSinDescansar
    
    SanaIntervaloDescansar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "SanaIntervaloDescansar"))
    FrmInterv.txtSanaIntervaloDescansar.Text = SanaIntervaloDescansar
    
    StaminaIntervaloDescansar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "StaminaIntervaloDescansar"))
    FrmInterv.txtStaminaIntervaloDescansar.Text = StaminaIntervaloDescansar
    
    IntervaloSed = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloSed"))
    FrmInterv.txtIntervaloSed.Text = IntervaloSed
    
    IntervaloHambre = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloHambre"))
    FrmInterv.txtIntervaloHambre.Text = IntervaloHambre
    
    IntervaloVeneno = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloVeneno"))
    FrmInterv.txtIntervaloVeneno.Text = IntervaloVeneno
    
    IntervaloParalizado = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloParalizado"))
    FrmInterv.txtIntervaloParalizado.Text = IntervaloParalizado
    
    IntervaloInvisible = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloInvisible"))
    FrmInterv.txtIntervaloInvisible.Text = IntervaloInvisible
    
    IntervaloFrio = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloFrio"))
    FrmInterv.txtIntervaloFrio.Text = IntervaloFrio
    
    IntervaloWavFx = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloWAVFX"))
    FrmInterv.txtIntervaloWAVFX.Text = IntervaloWavFx
    
    IntervaloInvocacion = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloInvocacion"))
    FrmInterv.txtInvocacion.Text = IntervaloInvocacion
    
    IntervaloParaConexion = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloParaConexion"))
    ...
    IntervaloUserPuedeCastear = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloLanzaHechizo"))
    FrmInterv.txtIntervaloLanzaHechizo.Text = IntervaloUserPuedeCastear
    
    IntervaloUserPuedeTrabajar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloTrabajo"))
    FrmInterv.txtTrabajo.Text = IntervaloUserPuedeTrabajar
    
    IntervaloUserPuedeAtacar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloUserPuedeAtacar"))
    FrmInterv.txtPuedeAtacar.Text = IntervaloUserPuedeAtacar
    
    'TODO : Agregar estos intervalos al form!!!
    IntervaloMagiaGolpe = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloMagiaGolpe"))
    IntervaloGolpeMagia = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloGolpeMagia"))
    IntervaloGolpeUsar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloGolpeUsar"))
    
    MinutosWs = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloWS"))

    If MinutosWs < 60 Then MinutosWs = 180
    
    MinutosGuardarUsuarios = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloGuardarUsuarios"))
    
    IntervaloCerrarConexion = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloCerrarConexion"))
    IntervaloUserPuedeUsar = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloUserPuedeUsar"))
    IntervaloFlechasCazadores = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloFlechasCazadores"))
    
    IntervaloOculto = val(GetVar(ConfigPath & "Server.ini", "INTERVALOS", "IntervaloOculto"))
    
    '&&&&&&&&&&&&&&&&&&&&& FIN TIMERS &&&&&&&&&&&&&&&&&&&&&&&
      
    RECORDusuarios = val(GetVar(ConfigPath & "Server.ini", "INIT", "RECORD"))
      
    'Max users
    Temporal = val(GetVar(ConfigPath & "Server.ini", "INIT", "MaxUsers"))
    ...
    'PorcentajeRecuperoMana = val(GetVar(ConfigPath & "Server.ini", "BALANCE", "PorcentajeRecuperoMana"))
